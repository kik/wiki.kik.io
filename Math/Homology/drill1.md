...
* $\Ker \delta_1 = \\{ x_1 \langle v_0v_1 \rangle + x_2 \langle v_1v_2 \rangle +x_3 \langle v_0v_2 \rangle | x_1(\langle v_1 \rangle - \langle v_0 \rangle) + x_2(\langle v_2 \rangle - \langle v_1 \rangle) + x_3(\langle v_2 \rangle - \langle v_0 \rangle) = 0 \\}$
    ...
    * なので
    * $x1 = x2 = -x3$
* $\Ker \delta_1 = R(\langle v_0v_1 \rangle + \langle v_1v_2 \rangle - \langle v_0v_2 \rangle) \cong R$
* $\Ima \delta_2 = 0$
...
* $H_1(K) = R(\langle v_0v_1 \rangle + \langle v_1v_2 \rangle - \langle v_0v_2 \rangle) \cong R$
* $k\ne 0, 1$のとき$H_k(K) = 0$
...
* 6つの三角形に分割しないといけない。大変なので略。もっと簡単な方法を考えるほうがよい。

[[Math/Homology/drill2]]